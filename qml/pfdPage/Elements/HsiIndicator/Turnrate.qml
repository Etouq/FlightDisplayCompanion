...
Item {
    ...
    Shape {
        ShapePath {
            ...
            PathAngleArc { centerX: 345.6; centerY: 288; radiusX: 239.26153846153846; radiusY: 239.26153846153846; startAngle: 270; sweepAngle: HSIndicator.turnRate }
            PathAngleArc { centerX: 345.6; centerY: 288; radiusX: 230.4; radiusY: 230.4; startAngle: 270 + HSIndicator.turnRate; sweepAngle: -HSIndicator.turnRate; moveToStart: false }
        }
    }

    Shape {
        visible: HSIndicator.turnRate <= -24
        ShapePath {
            fillColor: "#D12BC7"
            strokeColor: "transparent"
