...
Item {
    ...
    Shape {
        ShapePath {
            fillColor: Airspeed.redCursor ? "red" : "#1a1d21"
    ...
    Item {
        ...
        Item {
            ...
            Text {
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Airspeed.rawAirspeed <= 20 ? " " : (2 + endDigitsGroup.endCenter) % 10
            }
            ...
            Text {
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Airspeed.rawAirspeed <= 20 ? " " : (1 + endDigitsGroup.endCenter) % 10
            }
            ...
            Text {
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Airspeed.rawAirspeed <= 20 ? "-" : endDigitsGroup.endCenter % 10
            }
            ...
            Text {
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Airspeed.rawAirspeed <= 20 ? " " : (9 + endDigitsGroup.endCenter) % 10
            }
            ...
            Text {
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Airspeed.rawAirspeed <= 20 ? " " : (8 + endDigitsGroup.endCenter) % 10
            }
        }
    }
    ...
    Connections {
        ...
        function onAirspeedChanged() {
            updateDigits(Airspeed.airspeed);
        }
    }
