...
Item {
    ...
    Item {
        ...
        Item {
            ...
            Text {
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Math.abs(Math.round((altInterface.altitude + 20) % 100 / 10) % 10) + "0"
            }
            Text {
                x: 6.72
                anchors.baseline: parent.top
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Math.abs(Math.round((altInterface.altitude + 10) % 100 / 10) % 10) + "0"
            }
            Text {
                x: 6.72
                anchors.baseline: parent.top
                ...
                font.family: "Roboto Mono"
                font.pixelSize: 48
                text: Math.abs(Math.round(altInterface.altitude % 100 / 10) % 10) + "0"
            }
            Text {
                x: 6.72
                anchors.baseline: parent.top
    ...
    Connections {
        ...
        function onAltitudeChanged() {
            updateDigits(altInterface.altitude);
        }
    }

    Component.onCompleted: updateDigits(altInterface.altitude);
